                ...
                <div className="dashboard">
                    ...
                    <div className="dashboard-summary">
                        ...
                        <p className="summary-paragraph">
                            ...
                            The arrows show the difference between interval medians of "Actual" days and their expected completion dates by using green, yellow and red coloring. Click on two milestone circles to get a custom median!
                        </p>
                    </div>
                </div>
            )
